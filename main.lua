...
ChiliadDB.ready(function()
    ...
    local currentIndex = ChiliadDB.getCollectionCurrentIndex({collection = 'chiliad_tester'})
    assert(currentIndex == currentIndexCheck)
    ...
    local currentIndex2 = ChiliadDB.getCollectionCurrentIndex({collection = 'chiliad_tester'})
    assert(currentIndex2 == currentIndexCheck + 1)
    ...
    local count = ChiliadDB.getCollectionDocumentCount({collection = 'chiliad_tester'})
    assert(count == 3)
    print("Test 14 : find 5 - ^2PASSED^7")

    print("Test 15 : handle incorrect request - ^3RUNNING^7")
    local results15 = ChiliadDB.find({table = 'asdf', options = {limit = 1}})
    assert(type(results15) == 'table')
    assert(#results15 == 0)
    print("Test 15 : handle incorrect request - ^2PASSED^7")
    ...
    print("Test 20 : getCollectionCurrentIndex for non-existent collection - ^3RUNNING^7")
    local results20 = ChiliadDB.getCollectionCurrentIndex({collection = 'asdfasdf'})
    assert(results20 == nil)
    print("Test 20 : getCollectionCurrentIndex for non-existent collection - ^2PASSED^7")

    print("Test 21 : getCollectionCurrentIndex for valid collection - ^3RUNNING^7")
    local results21 = ChiliadDB.getCollectionCurrentIndex({collection = 'chiliad_tester'})
    assert(results21 == 4)
    print("Test 21 : getCollectionCurrentIndex for valid collection - ^2PASSED^7")
    
    print("Test 22 : create more holes and check order - ^3RUNNING^7")
    local id4 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    local id5 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    local id6 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    local id7 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    ...
    local id11 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    local id12 = ChiliadDB.insert({collection = 'chiliad_tester', document = {name = "test70", age = 10}, options = {selfInsertId = 'testId'}})
    ...
    -- print(json.encode(results25, {indent = true}))
    ...
    -- print(json.encode(results26, {indent = true}))
